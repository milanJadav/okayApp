...
const profileData = [
  {
    ...
    subTitle: 'View your customer that you worked for',
    logo: IMAGES.IC_USERS,
  },
  {
    id: 2,
    title: 'Past architects',
    subTitle: 'See your past architects',
    logo: IMAGES.IC_SCALE,
  },
  {
    id: 3,
    title: 'Account',
...
const AgencyProfile = props => {
  ...
  const onProfileSettingClick = id => {
    switch (id) {
      case 1:
        props.navigation.navigate('PastCustomers');
        break;
      case 2:
        props.navigation.navigate('PastArchitects');
        break;
      case 3:
